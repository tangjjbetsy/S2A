...
def jacobean_product_squared_euclidean(X, Y, Bt):
    ...
    Jacobean product of squared Euclidean distance matrix and alignment matrix. See equations 2 and
    2.5 of
...
class SoftDTW(torch.nn.Module):
    ...
    def forward(self, X, Y):
        """Compute the soft-DTW value between X and Y :param X: One batch of examples, batch_size x
        seq_len x dims :param Y: The other batch of examples, batch_size x seq_len x dims :return:
