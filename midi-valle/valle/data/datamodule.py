...
from valle.data.dataset import SpeechSynthesisDataset, MidiSynthesisDataset
...
class TtsDataModule:
    ...
    def train_dataloaders(
        ...
        if self.args.on_the_fly_feats:
            ...
            #NOTE(Jingjing) For midi
            train = MidiSynthesisDataset(
                get_midi_token_collater(),
                feature_input_strategy=_get_input_strategy(
                    self.args.input_strategy, self.args.dataset, cuts_train
                ),
                cut_transforms=transforms,
