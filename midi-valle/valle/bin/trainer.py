...
def compute_loss(
    ...
    midi_tokens_lens = batch["midi_tokens_lens"].to(device)
    assert midi_tokens.ndim == 3
    ...
    with warnings.catch_warnings():
        ...
        info["utterances"] = midi_tokens.size(0)
    ...
    while True:
        ...
        if batch_idx % 100 == 0 and params.dtype in ["float16", "fp16"]:
            ...
            if cur_grad_scale < 1.0 or (
                cur_grad_scale < 8.0 and batch_idx % 100 == 0
            ):
